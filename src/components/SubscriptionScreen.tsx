        ...
        {!isSubscribed && (
          <>
            <div className="grid gap-4 mb-6">
              <div
                onClick={() => !paying && handlePayment('monthly')}
                className={`rounded-[14px] p-5 cursor-pointer transition-all duration-200 border-2 bg-white dark:bg-[#1E293B] hover:border-[#1565C0] dark:hover:border-[#42A5F5] hover:shadow-[0_4px_20px_rgba(21,101,192,0.14)] relative overflow-hidden ${paying === 'monthly' ? 'opacity-60 pointer-events-none' : ''}`}
              >
                {paying === 'monthly' && (
                  <div className="absolute inset-0 flex items-center justify-center bg-white/60 dark:bg-[#1E293B]/60 z-10">
              ...
              <div
                onClick={() => !paying && handlePayment('yearly')}
                className={`rounded-[14px] p-5 cursor-pointer transition-all duration-200 border-2 bg-white dark:bg-[#1E293B] hover:border-[#1565C0] dark:hover:border-[#42A5F5] hover:shadow-[0_4px_20px_rgba(21,101,192,0.14)] relative overflow-hidden ${paying === 'yearly' ? 'opacity-60 pointer-events-none' : ''}`}
              >
                {paying === 'yearly' && (
                  <div className="absolute inset-0 flex items-center justify-center bg-white/60 dark:bg-[#1E293B]/60 z-10">
                    <div className="w-8 h-8 border-4 border-[#1565C0] border-t-transparent rounded-full animate-spin" />
