...
export const EXAM_DATA: ExamData = {
  ...
  WAEC: { icon: '📘', subjects: ['English Language', 'Mathematics', 'Further Mathematics', 'Biology', 'Chemistry', 'Physics', 'Economics', 'Commerce', 'Marketing', 'Financial Accounting', 'Bookkeeping', 'Literature in English', 'Government', 'CRS', 'Civic Education', 'Computer Studies', 'Yoruba', 'Igbo', 'Hausa'] },
  NECO: { icon: '📗', subjects: ['English Language', 'Mathematics', 'Further Mathematics', 'Biology', 'Chemistry', 'Physics', 'Economics', 'Commerce', 'Marketing', 'Financial Accounting', 'Bookkeeping', 'Literature in English', 'Government', 'CRS', 'Civic Education', 'Computer Studies', 'Yoruba', 'Igbo', 'Hausa'] },
  ...
  THEORY: { icon: '📝', subjects: ['WAEC', 'NECO'] },
}
